...
from tensorboardX import SummaryWriter # 新增
import pynvml # 新增
...
def train(config_path):
    ...
    # === 在这里添加内存检测和等待 ===
    # 根据你的OOM错误，需要分配 7.57 GiB，所以我们要求 8 GiB
    ...
    for epoch in range(epochs):
        ...
        while True:
            try:
                ...
                if 'CUDA out of memory' in str(e):
                    print(f"CUDA Out of Memory caught. Releasing cache and retrying...")
        ...
        # 新增：实时保存最优模型
        model_save_path = os.path.join(config['model_folder'], "diffusion_current_model.pth")
